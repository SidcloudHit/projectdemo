                            ...
                            <div class="card card-body" style="border-color: #0056b3;">
                                <div class="panel panel-primary">
                                    <div class="panel-heading text-center" style="background-color: #f5c6cb;">
                                        <b>Beneficiaries list under MB-Kisan</b>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="form-row">     
                                            <div class="form-group col-md-3">
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">District<span style="color: red"> *</span> </label>
                                                    <select id="ddlState" name="ddlState" class="form-control" style="width: 100%;">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">subdivision <span style="color: red"> *</span></label>
                                                    <select id="ddlState" name="ddlState" class="form-control" style="width: 100%;">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">block <span style="color: red"> *</span></label>
                                                    <select id="ddlState" name="ddlState" class="form-control" style="width: 100%;">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">village <span style="color: red"> *</span></label>
                                                    <select id="ddlState" name="ddlState" class="form-control" style="width: 100%;" >
                                        ...
                                        <div class="form-group col-md-6">
                                            <div class="input-group input-group-sm">
                                                <input type="submit" name="btnGetdata" id="btnGetdata" value="Get Data" id="btnSendOTP" class="btn btn-primary">    
                                            </div>
                                        </div>
