                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="form-group col-md-6">
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">
                                                        <input type="radio" name="optradio"> Rural Farmer Registration
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <label class="radio-inline" style="color:#651472; font-weight: bold">
                                                        <input type="radio"  name="optradio"> Urban Farmer Registration
                                                    </label> 
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="text" class="form-control" id="mainCaptcha" readonly="true" style="text-decoration: line-through; border-radius: 4px;" name="mainCaptcha" placeholder=""/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4" style="color:#651472; font-weight: bold" id="txt_captcha_result">Image Text</label>
                                            <div class="input-group input-group-sm">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4" style="color:#651472; font-weight: bold">Enter OTP</label>
                                            <div class="input-group input-group-sm">
                                                <input id="txtotp" name="txtotp" placeholder="OTP" class="form-control" required="true" value="" type="text" >
                                            </div>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <div class="input-group input-group-sm">
                                                <input type="submit" name="btnSendOTP" value="Send Otp" id="btnSendOTP" class="btn btn-primary">    
                                            </div>
                                        </div>
