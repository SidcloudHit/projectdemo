<%-- 
    Document   : surpervisordashboard
    Created on : 28 Sep, 2020, 2:00:36 PM
    Author     : acer
--%>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <script language="Javascript" type="text/javascript">
            ...
            function AjaxDashboard()
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<%=request.getContextPath()%>/SlvtSupervisorDashboard',
                    data:
                            {
                                "flagType": "1"
                            },
                    success: function (retresult) {
                        ...
                        totSupervisorList = objsdataparsed.TOTSURVEYOR;
                        SupervisorList = objsdataparsed.SURVEYORLIST;
                        ...
                        optstr += "<div>";
                        optstr += "<div class=\"text-value-lg text-center\" style=\" font-size:2.5rem\" id=\"totsup\">" + totSupervisorList + "&nbsp;<strong>Total Surveyor(s)</strong></div>";
            ...
            function AjaxSupervisorArea(uname, userid)
            {
                ...
                $.ajax({
                    ...
                    success: function (retresult) {
                        ...
                        optstr += " <div class=\"row\">";
                        optstr += "<div class=\"col-sm-12 col-lg-12\">";
                        optstr += " <div class=\"pb-3\"><strong>Surveyor Name: " + uname + "</strong></div>";
